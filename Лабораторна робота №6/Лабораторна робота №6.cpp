...
void second_task(double Accuracy, int x_2) {
	 ...
	 {
		 current_member *= (-x_2) / (i + 1);
		 if (j == 7) cout << "Сума перших 5 членів ряду Тейлора (за допомогою цикла for)      =" << setprecision(16) << sum << endl;
	 }
	 ...
	 {
		 current_member *= (-x_2) / (i + 1);
		 if (j == 7) cout << "Сума перших 5 членів ряду Тейлора (за допомогою цикла while)    =" << setprecision(16) << sum_while << endl;
		 j++;
	 ...
	 do
	 {
		 if (j == 7) cout << "Сума перших 5 членів ряду Тейлора (за допомогою цикла do while) =" << setprecision(16) << sum_do_while << endl;
		 current_member *= (-x_2) / (i + 1);
